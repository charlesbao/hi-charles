...
> [json-server](https://github.com/typicode/json-server) get a full fake REST API with __zero coding__ in __less than 30 seconds__ (seriously)<!--more-->

__json-server__ created with <3 for front-end developers who need a quick back-end for prototyping and mocking.
